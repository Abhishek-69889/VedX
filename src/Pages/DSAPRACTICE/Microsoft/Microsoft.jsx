...
import dsaTopics from "./Microsoft.json"; 
...
const Microsoft = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 p-6">
      <h1 className="text-3xl font-bold mb-6 text-center bg-black/90 p-20 text-white rounded-xl"><span className="text-white/50">Microsoft </span>DSA Practice Questions</h1>
